...
window.addQuestionOrNote = addQuestionOrNote;
...
function addNote() {
	...
	const noteHtml = `
                <div class="note-card card card-border border-base-300 dark:bg-base-200 shadow-lg" id="${noteId}" data-sequence="${nextNumber}">
                    <div class="card-body">
                        ...
                        <fieldset class="fieldset">
                            ...
                            <div class="media-preview mt-4 hidden" id="media-preview-${noteId}"></div>
                        </fieldset>
                    </div>
                </div>
            `;
