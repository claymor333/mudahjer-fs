...
<div class="fab-container" id="fab-container">
	<div class="tooltip tooltip-left" data-tip="Toggle Keyboard Navigation">
		<button type="button" id="toggleKeyboardNav" class="btn btn-circle btn-lg btn-accent fab" onclick="toggleKeyboardNavigation()">
	...
	<div class="tooltip tooltip-left">
		...
		<button type="button" class="btn btn-circle btn-lg btn-primary fab" onclick="addQuestionOrNote()">
			<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
